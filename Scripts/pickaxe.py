...
class PickAxe:
    def __init__(self, x, y):
        ...
        self.frame_four = sprite_sheet.subsurface(pygame.Rect(864, 2864, 32, 32))
        self.frame_five = sprite_sheet.subsurface(pygame.Rect(896, 2864, 32, 32))
        self.frame_six = sprite_sheet.subsurface(pygame.Rect(928, 2864, 32, 32))
        self.frame_one = pygame.transform.scale(self.frame_one, (self.pickaxe_size, self.pickaxe_size))
        self.frame_two = pygame.transform.scale(self.frame_two, (self.pickaxe_size, self.pickaxe_size))
        self.frame_three = pygame.transform.scale(self.frame_three, (self.pickaxe_size, self.pickaxe_size))
        self.frame_four = pygame.transform.scale(self.frame_four, (self.pickaxe_size, self.pickaxe_size))
        self.frame_five = pygame.transform.scale(self.frame_five, (self.pickaxe_size, self.pickaxe_size))
        self.frame_six = pygame.transform.scale(self.frame_six, (self.pickaxe_size, self.pickaxe_size))
        ...
        self.up_view_frame_one = sprite_sheet.subsurface(pygame.Rect(768, 2832, 32, 32))
        self.up_view_frame_two = sprite_sheet.subsurface(pygame.Rect(800, 2832, 32, 32))
        self.up_view_frame_three = sprite_sheet.subsurface(pygame.Rect(832, 2832, 32, 32))
        self.up_view_frame_four = sprite_sheet.subsurface(pygame.Rect(864, 2832, 32, 32))
        self.up_view_frame_five = sprite_sheet.subsurface(pygame.Rect(896, 2832, 32, 32))
        self.up_view_frame_six = sprite_sheet.subsurface(pygame.Rect(928, 2832, 32, 32))
        self.up_view_frame_one = pygame.transform.scale(self.up_view_frame_one, (self.pickaxe_size, self.pickaxe_size))
        self.up_view_frame_two = pygame.transform.scale(self.up_view_frame_two, (self.pickaxe_size, self.pickaxe_size))
        self.up_view_frame_three = pygame.transform.scale(self.up_view_frame_three, (self.pickaxe_size, self.pickaxe_size))
        self.up_view_frame_four = pygame.transform.scale(self.up_view_frame_four, (self.pickaxe_size, self.pickaxe_size))
        self.up_view_frame_five = pygame.transform.scale(self.up_view_frame_five, (self.pickaxe_size, self.pickaxe_size))
        self.up_view_frame_six = pygame.transform.scale(self.up_view_frame_six, (self.pickaxe_size, self.pickaxe_size))

...
class WaterCan:
    def __init__(self, x, y):
        ...
        self.hoe_size = 64
        self.frame_one = sprite_sheet.subsurface(pygame.Rect(768, 2976 - 208, 32, 32))
        self.frame_two = sprite_sheet.subsurface(pygame.Rect(800, 2976 - 208, 32, 32))
        self.frame_three = sprite_sheet.subsurface(pygame.Rect(832, 2976 - 208, 32, 32))
        self.frame_four = sprite_sheet.subsurface(pygame.Rect(864, 2976 - 208, 32, 32))
        self.frame_five = sprite_sheet.subsurface(pygame.Rect(896, 2976 - 208, 32, 32))
        self.frame_six = sprite_sheet.subsurface(pygame.Rect(928, 2976 - 208, 32, 32))
        ...
        self.up_view_frame_one = sprite_sheet.subsurface(pygame.Rect(768, 2944 - 208, 32, 32))
        self.up_view_frame_two = sprite_sheet.subsurface(pygame.Rect(800, 2944 - 208, 32, 32))
        self.up_view_frame_three = sprite_sheet.subsurface(pygame.Rect(832, 2944 - 208, 32, 32))
        self.up_view_frame_four = sprite_sheet.subsurface(pygame.Rect(864, 2944 - 208, 32, 32))
        self.up_view_frame_five = sprite_sheet.subsurface(pygame.Rect(896, 2944 - 208, 32, 32))
        self.up_view_frame_six = sprite_sheet.subsurface(pygame.Rect(928, 2944 - 208, 32, 32))

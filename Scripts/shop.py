...
class Shop:
    ...
    def __init__(self, pos_x: int, pos_y: int, floutwitch, farmbotany):
        ...
        self.exit_button = ui.FBButton(50, 50, 100, 100, "Exit", self.font, keyboard=self.keyboard, image="Sprites/tile_set.png", img_pos_x=2944, img_pos_y=64, img_size_x=32, img_size_y=32)
        
        self.buy_button = ui.FBButton(50, 500, 100, 100, "Buy", self.font, keyboard=self.keyboard, image="Sprites/tile_set.png", img_pos_x=2944, img_pos_y=64, img_size_x=32, img_size_y=32)
        self.exit_buy_menu_button = ui.FBButton(50, 50, 100, 100, "Back", self.font, keyboard=self.keyboard, image="Sprites/tile_set.png", img_pos_x=2944, img_pos_y=64, img_size_x=32, img_size_y=32)
        
        self.sell_button = ui.FBButton(550, 500, 100, 100, "Sell", self.font, keyboard=self.keyboard, image="Sprites/tile_set.png", img_pos_x=2944, img_pos_y=64, img_size_x=32, img_size_y=32)
        self.actual_sell_button = ui.FBButton(550, 500, 100, 100, "Sell", self.font, keyboard=self.keyboard, image="Sprites/tile_set.png", img_pos_x=2944, img_pos_y=64, img_size_x=32, img_size_y=32)
        self.exit_sell_menu_button = ui.FBButton(50, 50, 100, 100, "Back", self.font, keyboard=self.keyboard, image="Sprites/tile_set.png", img_pos_x=2944, img_pos_y=64, img_size_x=32, img_size_y=32)
